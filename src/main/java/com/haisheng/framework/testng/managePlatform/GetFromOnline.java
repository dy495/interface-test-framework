...
public class GetFromOnline {
    ...
    private String uploadLayoutPic(String picA) throws Exception {
    ...
    private String getDeviceIdByName(String response,String name) {
    ...
    private String getRegionIdNyName(String response,String name) {
        JSONArray list = JSON.parseObject(response).getJSONObject("data").getJSONArray("list");
    ...
    private String getLayoutId(String response) {
        JSONObject data = JSON.parseObject(response).getJSONObject("data");
    ...
    public String addDevice(String name, String deviceType, String sceneType, String cloudSceneType, String subjectId) throws Exception {
...
//    即已绑定机器列表
    ...
    //    3、增加节点对应服务&配置
    public String nodeServiceConfig(String serviceId, String nodeId) throws Exception {
    ...
    public String getCloud() throws Exception {
        String url  = "http://39.106.253.135/admin/data/sceneDevice/list";
