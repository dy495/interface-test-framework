...
public class ManagePlatformOnline {
    ...
    //    区域用
    private int LAYOUT_ID_REGION = 968;//listLayoutDSCheck,layoutMappingCheck
    private String REGION_ID = "1088";

    //    进出口用
    private String ENTRANCE_REGION_ID = "1089";
    private String ENTRANCE_ID = "1090";

    private String serviceAcquaintance = "13";
    private String servicePassenger = "3";

    private String genAuthURL = "http://39.106.253.135/administrator/login";
    ...
    private String CI_CMD = "curl -X POST http://liaoxiangru:liaoxiangru@192.168.50.2:8080/job/management-platform-online/buildWithParameters?case_name=";

    private String URL_prefix = "http://39.106.253.135";
...
//            将response存入数据库
    ...
    void genAuth() {
        ...
        String json =
                "{\n" +
                        "  \"email\": \"zhoutao@winsense.ai\"," +
                        "  \"password\": \"5bb5cc5a92a99042cd281d33c93541e4\"" +
                        "}";
        try {
    ...
    public static Object[][] nonLayoutDevice() {
        ...
        return new Object[][]{
                ...
                new Object[]{
                        DEVICE_NO_BIND, StatusCode.SUCCESS//没有绑定任何平面的设备
                }
        };
    }
