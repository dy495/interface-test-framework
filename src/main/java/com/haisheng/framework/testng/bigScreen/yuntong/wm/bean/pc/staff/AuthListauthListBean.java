package com.haisheng.framework.testng.bigScreen.yuntong.wm.bean.pc.staff;
...
/**
 * 24.7. 权限员工列表 （谢） （2020-12-23）
 *
 * @author wangmin
 * @date 2021-06-01 18:39:23
 */
@Data
public class AuthListauthListBean implements Serializable {
    /**
     * 描述 数据列表
     * 版本 v1.0
     */
