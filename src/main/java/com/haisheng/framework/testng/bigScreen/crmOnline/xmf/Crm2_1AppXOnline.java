...
//            //完成接待
            ...
            crm.finishReception2(sale_id, reception_id, customer_id, pp.customer_name, PhoneList, "FU");
...
//            ll3.put("type_comment", "试乘试驾体验评价");
    ...
    //    @Test(priority = 12)
    public void driverEvaluateo() {
        logger.logCaseStart(caseResult.getCaseName());
        try {
            JSONObject json;
            json = pf.creatCustOld(pp.customer_phone_number);
            ...
            //新建试驾,审核通过
            pf.creatDriver(id, customerId, pp.customer_name, pp.customer_phone_number, 1);
            //销售登录完成接待
...
//            String userLoginName="销售顾问xia";
            ...
            crm.finishReception2(sale_id, reception_id, customer_id, customer_name, PhoneList, "FU");
...
//            crm.finishReception2("uid_c01f9419",2994L, 17398L,"annu",PhoneList,"FU");
...
//    @Test
    ...
    /**
     * @description :新增注销试驾车，新建试驾下拉列表+1
