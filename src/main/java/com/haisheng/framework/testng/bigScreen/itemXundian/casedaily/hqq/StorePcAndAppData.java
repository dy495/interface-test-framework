...
import com.haisheng.framework.testng.bigScreen.itemXundian.scene.history.shop.ConversionScene;
import com.haisheng.framework.testng.bigScreen.itemXundian.scene.history.shop.AgeGenderDistributionScene;
import com.haisheng.framework.testng.bigScreen.itemXundian.scene.history.shop.TrendPvUvScene;
import com.haisheng.framework.testng.bigScreen.itemXundian.scene.realtime.shop.PvUvScene;
import com.haisheng.framework.testng.bigScreen.itemXundian.scene.realtime.shop.TotalScene;
import com.haisheng.framework.testng.bigScreen.itemXundian.scene.shop.page.PassengerFlowScene;
...
//        md.login("2842729999@qq.com", "d1487f65671ae61d513764093af222d1");
    ...
    public void homePage_data_7() {
        ...
        try {
            ...
            //pc各门店到访人数之和
            List<String> shopIds = getPcShopIds();
            int sumTodayUv = shopIds.stream().map(shopId -> PvUvScene.builder().shopId(shopId).build()).mapToInt(realTimeScene -> getTypeSum(realTimeScene, "today_uv")).sum();
            CommonUtil.valueView(todayUv, sumTodayUv);
    ...
    public void homePage_data_8() {
        ...
        try {
            ...
            //pc各门店到访人次之和
            List<String> shopIds = getPcShopIds();
            int sumTodayUv = shopIds.stream().map(shopId -> PvUvScene.builder().shopId(shopId).build()).mapToInt(realTimeScene -> getTypeSum(realTimeScene, "today_pv")).sum();
    ...
    public void homePage_data_9() {
        ...
        try {
            ...
            int appSum = appShopIds.stream().map(shopId -> AppHistoryPvUvScene.builder().shopId(shopId).day(date).build()).mapToInt(scene -> getTypeSum(scene, "uv")).sum();
            //pc各门店到访人数之和
            List<String> shopIds = getPcShopIds();
            int pcSum = shopIds.stream().map(shopId -> TrendPvUvScene.builder().shopId(shopId).day(date).build()).mapToInt(realTimeScene -> getTypeSum(realTimeScene, "today_uv")).sum();
    ...
    public void homePage_data_10() {
        ...
        try {
            ...
            String date = DateTimeUtil.addDayFormat(new Date(), -1);
            List<String> appShopIds = getAppShopIds();
            int appSum = appShopIds.stream().map(shopId -> AppHistoryPvUvScene.builder().shopId(shopId).day(date).build()).mapToInt(scene -> getTypeSum(scene, "pv")).sum();
            //pc各门店到访人次之和
            List<String> shopIds = getPcShopIds();
            int pcSum = shopIds.stream().map(shopId -> TrendPvUvScene.builder().shopId(shopId).day(date).build()).mapToInt(realTimeScene -> getTypeSum(realTimeScene, "today_pv")).sum();
            CommonUtil.valueView(appSum, pcSum);
    ...
    public void passengerFlow_data_1() {
        ...
        try {
            ...
            shopIds.forEach(shopId -> {
                IScene scene = AppRealHourAgeGenderDistributionScene.builder().shopId(shopId).build();
    ...
    public void passengerFlow_data_4() {
        ...
        try {
            List<String> shopIds = getAppShopIds();
            shopIds.forEach(shopId -> {
                IScene scene = AppRealHourTotalScene.builder().shopId(shopId).build();
                ...
                IScene scene1 = AppRealHourPvUvScene.builder().shopId(shopId).build();
                //今日各时刻中人次之和
    ...
    public void passengerFlow_data_12() {
        ...
        try {
            ...
            shopIds.forEach(shopId -> {
                ...
                IScene scene1 = TotalScene.builder().shopId(shopId).build();
    ...
    public void passengerFlow_data_14() {
        ...
        try {
            ...
            List<String> shopIds = getAppShopIds();
            shopIds.forEach(shopId -> {
                IScene scene = AppHistoryPvUvScene.builder().day(date).shopId(shopId).build();
                int appUvSum = getTypeSum(scene, "uv");
                IScene scene1 = PvUvScene.builder().shopId(shopId).build();
    ...
    public void passengerFlow_data_22() {
        ...
        try {
            ...
            shopIds.forEach(shopId -> dayList.forEach(day -> {
                IScene scene = AppAgeGenderDistributionScene.builder().shopId(shopId).day(day).build();
    ...
    public void passengerFlow_data_24() {
        ...
        try {
            ...
            shopIds.forEach(shopId -> monthList.forEach(month -> {
                IScene scene = AppAgeGenderDistributionScene.builder().shopId(shopId).month(month).build();
                if (hasType(scene, "gender")) {
                    double percent = getTypeSum(scene, "gender", "gender_ratio_number");
                    CommonUtil.valueView(percent);
    ...
    public void passengerFlow_data_29() {
        ...
        try {
            ...
            List<String> monthList = getMonthList();
            shopIds.forEach(shopId -> monthList.forEach(month -> {
                IScene appScene = AppAgeGenderDistributionScene.builder().shopId(shopId).month(month).build();
...
//                double appPercent = percentToDouble(appGenderRatio);
                ...
                IScene pcScene = AgeGenderDistributionScene.builder().month(month).shopId(shopId).build();
...
//                double appPercent = percentToDouble(appGenderRatio);
    ...
    public void passengerFlow_data_32() {
        ...
        try {
            ...
            List<String> monthList = getMonthList();
            shopIds.forEach(shopId -> monthList.forEach(month -> {
                IScene appScene = AppHistoryConversionScene.builder().month(month).shopId(shopId).build();
                ...
                IScene pcScene = ConversionScene.builder().shopId(shopId).month(month).build();
...
//            String newDate = y > 9 ? year + "-" + y : year + "-0" + y;
    ...
    public List<String> getPcShopIds() {
        ...
        PassengerFlowScene.PassengerFlowSceneBuilder builder = PassengerFlowScene.builder();
