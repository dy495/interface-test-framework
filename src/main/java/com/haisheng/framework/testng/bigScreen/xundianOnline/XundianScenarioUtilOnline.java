...
public class XundianScenarioUtilOnline extends TestCaseCommon {
    ...
    private static volatile XundianScenarioUtilOnline instance = null;

    private XundianScenarioUtilOnline() {
    }

    public static XundianScenarioUtilOnline getInstance() {

        if (null == instance) {
            synchronized (XundianScenarioUtilOnline.class) {
                if (null == instance) {
                    //这里
                    instance = new XundianScenarioUtilOnline();
                }
            }
        }
...
//---------------------------------------------------分界线-----------------------------------
    ...
    public JSONObject CheckListAdd(String name, String desc, String title, String comment) throws Exception {
        ...
        long i = Long.valueOf(getXunDianShopOnline());
        shop_list.add(i);
...
//    }
    ...
    public JSONObject checksItemSubmitN(long patrolId, long listId, long itemId, List<String> picList) throws Exception {
        ...
        JSONObject json = new JSONObject();
        json.put("shop_id", getXunDianShopOnline());
    ...
    public JSONObject submitOne(Integer check_result, long item_id, long list_id, long patrol_id) throws Exception {
        String url = "/patrol/shop/checks/item/submit";
        JSONObject json = new JSONObject();
        String shopid = getXunDianShopOnline();
    ...
    public JSONObject xunDianCenterDetail() throws Exception {
        String url = "/patrol/shop/detail";
        JSONObject json = new JSONObject();
        json.put("id", getXunDianShopOnline());
