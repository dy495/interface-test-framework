package com.haisheng.framework.testng.bigScreen.yuexiuOnline;
...
//                            搜索结果正确时，成功数+1
    ...
    public String uploadLayoutPic(String picA) {
        ...
        String downloadImagePath = "src/main/java/com/haisheng/framework/testng/bigScreen/yuexiuDaily/multimedia/picture/faceUrl.png";
