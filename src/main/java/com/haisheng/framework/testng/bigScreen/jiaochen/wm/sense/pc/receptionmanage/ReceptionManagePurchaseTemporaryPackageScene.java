...
/**
 * 22.10. 购买临时套餐（张小龙）(2020-12-17)
 *
 * @author wangmin
 * @date 2021-08-30 14:26:55
 */
@Builder
public class ReceptionManagePurchaseTemporaryPackageScene extends BaseScene {
    /**
     * 描述 接待id
     * 是否必填 true
     * 版本 v2.0
    ...
    public String getPath() {
        return "/car-platform/pc/reception-manage/purchase-temporary-package";
    }
}