package com.haisheng.framework.testng.bigScreen.crmDaily;
...
import com.haisheng.framework.testng.bigScreen.crmDaily.commonDs.CustomerInfo;
import com.haisheng.framework.testng.bigScreen.crmDaily.commonDs.Driver;
...
import com.haisheng.framework.testng.bigScreen.crmDaily.xmf.interfaceDemo.*;
...
public class CrmScenarioUtil extends TestCaseCommon {
    ...
    public JSONObject afterSaleCustomerDetail(String customerId, String vehicleId) {
        String url = "/porsche/app/after_sale/customer-detail";
        JSONObject object = new JSONObject();
...
//        json1.put("test_drive_car",test_drive_car);
    ...
    public JSONObject driveradd5(Long receptionId, Long customer_id, String customerName, String phone, String driverLicensePhoto1Url,
                                 String sign_date, String sign_time, String apply_time, Long test_drive_car, String oss) {
        String url = "/porsche/daily-work/test-drive/app/addWithCustomerInfo";
        ...
        json1.put("ward_name_url", driverLicensePhoto1Url);
        json1.put("driver_license_photo_1_url", oss);
    ...
    public JSONObject driveradd6(destDriver dd) throws Exception {
        ...
        json1.put("driver_license_photo_1_url", dd.oss);
    ...
    public JSONObject deliverAddDX(deliverCar dc) throws Exception {
        ...
        json1.put("car_id", dc.car_id);
        json1.put("reception_id", dc.reception_id);
        json1.put("customer_name", dc.customer_name);
        json1.put("deliver_car_time", dc.deliver_car_time);
        json1.put("carModel", dc.car_id);
        json1.put("img_file", dc.img_file);
        json1.put("accept_show", dc.accept_show);
        json1.put("works", dc.works);
        json1.put("likes", dc.likes);
        json1.put("greeting", dc.greeting);
        json1.put("call", dc.call);
        json1.put("sign_name_url", dc.sign_name_url);
        json1.put("vehicle_chassis_code", dc.vehicle_chassis_code);
        if (dc.Empty != null) {
            json1.put(dc.Empty, "");
        }
        String json = json1.toJSONString();
    ...
    //预约维修
    public JSONObject appointmentRepair(Long my_car_id, String customer_name, String customer_phone_number, String appointment_date, String appointment_time, String description, Long time_range_id) {
...
//        checkMessage("预约试驾，" + emptyPara + "为空！", res, message);
    ...
    public JSONObject artilceView(int id) {
        String url = "/porsche/article/view/";
        JSONObject json = new JSONObject();
        json.put("id", id);
    ...
    public JSONObject appartilceDetail(Long id, String article_type) {
    ...
    //文章列表
    public JSONObject articlePage(Integer page, Integer size, String position) {
    ...
    //坑位列表
    public JSONObject positionList() {
    ...
    //------------------------售后------------------------
    //售后：客户管理->列表展示
    public JSONObject receptionAfterCustomerList(String search_condition, String search_date_start, String search_date_end, int page, int size) {
        String url = "/porsche/app/after_sale/reception_after_customer_list";
        JSONObject json1 = new JSONObject();
        if (!StringUtils.isEmpty(search_condition)) {
            json1.put("search_condition", search_condition);
        }
        if (!StringUtils.isEmpty(search_date_start)) {
            json1.put("search_date_start", search_date_start);
        }
        if (!StringUtils.isEmpty(search_date_end)) {
    ...
    //售后：客户管理->列表展示
    public JSONObject afterSaleCustomerList(String search_condition, String search_date_start, String search_date_end, int page, int size) {
     ...
     * 发送出门条
     */
    public JSONObject sendExitNote(String plateNumber, String afterRecordId) {
        String url = "/porsche/app/after_sale/send-exit-note";
        JSONObject object = new JSONObject();
    ...
    public JSONObject registeredCustomer1(long activity_task_id, String customer_name, String customer_phone_number) {
        String url = "/porsche/app/activity-task/registeredCustomer";
        JSONObject object = new JSONObject();
        object.put("activity_task_id", activity_task_id);
        object.put("customer_name", customer_name);
        object.put("customer_phone_number", customer_phone_number);
        return invokeApi(url, object, false);
    }
...
//    }
    ...
    public JSONObject addOrderCar(String customer_id, String reception_id, String vehicle_chassis_code) throws Exception {
        ...
        json1.put("customer_id", customer_id);
        json1.put("defray_type", 0);
        json1.put("pay_type", 1);
        json1.put("plate_type", 1);
        json1.put("reception_id", reception_id);
        json1.put("vehicle_chassis_code", vehicle_chassis_code);
        String json = json1.toJSONString();
        String result = httpPostWithCheckCode(url, json, IpPort);
    ...
    public static Object[][] add_car() {
        ...
        return new String[][]{
                ...
                {"ZDH20WEIABCDE" + (int) ((Math.random() * 9 + 1) * 1000000), getPlateNum() + "1", "ZDHZDHZDH" + (long) ((Math.random() * 9 + 1) * 10000000)}, //名字20位，车牌号8位，车架号17位
    ...
    public static Object[][] dcc_creat() {
        return new String[][]{
                ...
                {"!@#$%^&*()}{:?><~!", "139000" + (int) ((Math.random() * 9 + 1) * 10000), "京ZDH" + (int) ((Math.random() * 9 + 1) * 100)}, //名字符号，手机号，车牌号7位
                {"啊", "139000" + (int) ((Math.random() * 9 + 1) * 10000), "京ZDH" + (int) ((Math.random() * 9 + 1) * 1000)}, //名字1位，手机号，车牌号8位
    ...
    //前台客户列表
    public JSONObject markcustomerList() {
    ...
    //前台标记非客
    public JSONObject markNocustomer(JSONArray list) {
    ...
    //删除前台标记非客
    public JSONObject deleteNocustomer(String analysis_customer_id) {
    ...
    //前台标记为接待离店
    public JSONObject marknonReception(JSONArray list) {
    ...
    //删除前台标记为接待离店
    public JSONObject deleteNoReception(String analysis_customer_id) {
        String url = "/porsche/app/customer/risk_delete";
        JSONObject json = new JSONObject();
        json.put("analysis_customer_id", analysis_customer_id);
    ...
    //我的接待-购车档案列表
    public JSONObject customerInfo(String customer_id) {
    ...
    public JSONObject pcreceiptPageN(String size, String page, String name, String phone, String sale_type, String[] temp) {
        String url = "/porsche/administration/reception/page";
        JSONObject json = new JSONObject();
        json.put("size", size);
        json.put("page", page);
    ...
    public JSONObject pcreceiptPage(String size, String page, String name, String phone, String sale_type) {
        String url = "/porsche/administration/reception/page";
        JSONObject json = new JSONObject();
        json.put("size", size);
        json.put("page", page);
    ...
    //申请试驾获取oss
    public JSONObject addressDiscernment(String picurl) {
        String url = "/porsche/daily-work/test-drive/app/address-discernment";
        JSONObject json = new JSONObject();
        json.put("driver_license_photo_1_url", picurl);
    ...
    //app 变更接待
    public JSONObject jiebang(String analysis_customer_id, String customer_id, String type) {
        String url = "/porsche/app/sale-reception/change";
        JSONObject object = new JSONObject();
        object.put("analysis_customer_id", analysis_customer_id);
        object.put("customer_id", customer_id);
        object.put("type", type);
    ...
    //app 变更接待
    public JSONObject receptionapp(JSONArray analysis_customer_id) {
        String url = "/porsche/app/customer/reception";
        JSONObject object = new JSONObject();
        object.put("list", analysis_customer_id);
        String result = httpPostWithCheckCode(url, object.toJSONString(), IpPort);
        return JSON.parseObject(result).getJSONObject("data");
    }
