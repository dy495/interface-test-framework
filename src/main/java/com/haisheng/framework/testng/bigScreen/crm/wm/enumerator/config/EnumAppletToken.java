...
public enum EnumAppletToken {
    ...
    INS_WM_DAILY(EnumTestProduce.INS_DAILY.getAbbreviation(), "8yGD5FvHVo5AiVbMD6w+mg==", true, "15321527989"),

    INS_WM_ONLINE(EnumTestProduce.INS_ONLINE.getAbbreviation(), "", false, "15321527989"),

    INS_ZT_DAILY(EnumTestProduce.INS_DAILY.getAbbreviation(), "2L3Cfl86hg4mwNvKwJyabg==", true, "13604609869"),
