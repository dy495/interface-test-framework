...
public class MenjinTestHardwareDaily {
    ...
    public void delUserBatch() throws Exception {
        ...
        try (FileReader reader = new FileReader("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/h.txt");
...
//            String user_id = ""+ System.currentTimeMillis();
            ...
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/lv.png");
...
//            menjin.userUpdate(scope,user_id,image_type,face_image,"177BDC49","");
           ...
           // menjin.userAdd(menjin.EnDevice,"existpeopletest","BASE64",getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/51.png"),"","别删");
            //menjin.userAdd(menjin.existUserscope,"existpeopletest","BASE64",getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/51.png"),"","别删");
            //menjin.userAdd(menjin.EnDevice,"testtuisong","BASE64",getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/52.png"),"","别删");
            ...
            //for (int i = 1; i < 51; i++){
               // String user_id = "fifty0" + i;
                //String image_type = "BASE64";
                //String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/" + i + ".png");
...
//            menjin.operateDevice("7551524171351040","DISABLE");
    ...
    public void test() {
        ...
        try {
            ...
            String image_type = "BASE64";
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/w1.png");
    ...
    public void updateuser() {
        ...
        try {
            ...
            String user_id = "lvxueqing";
            String image_type = "BASE64";
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/吕雪晴.JPG");
            //menjin.userUpdate(scope,user_id,image_type,face_image,"177BDC49","小吕今天也是美女");
            menjin.userAdd(menjin.EnDevice,"existpeopletest","BASE64",getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/lvxueqing1.png"),"","别删");
