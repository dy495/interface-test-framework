...
/**
 * 24.1. 投保客户列表 （池）（2021-03-05）
 *
 * @author wangmin
 * @date 2021-07-27 18:26:28
 */
@Builder
public class InsuranceManagementCustomerPageListScene extends BaseScene {
    /**
     * 描述 页码 大于0
     * 是否必填 true
     * 版本 v1.0
    ...
    public String getPath() {
        return "/car-platform/pc/insurance-management/customer-page-list";
    }
}