...
/**
 * 30.9. 编辑内容营销活动 （谢）v3.0（2021-03-16）
 *
 * @author wangmin
 * @date 2021-08-30 14:26:55
 */
@Builder
public class ContentMarketingEditScene extends BaseScene {
    /**
     * 描述 活动类型 见字典表《活动类型》
     * 是否必填 true
     * 版本 v2.0
     ...
     * 版本 v3.0
     */
    private final Integer actionPoint;
    ...
    protected JSONObject getRequestBody() {
        ...
        object.put("action_point", actionPoint);
        object.put("id", id);
        return object;
    }
    ...
    public String getPath() {
        return "/car-platform/pc/activity/manage/content-marketing/edit";
    }
}