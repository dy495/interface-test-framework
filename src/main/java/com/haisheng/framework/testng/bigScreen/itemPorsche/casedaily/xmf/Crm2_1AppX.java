...
import com.haisheng.framework.testng.bigScreen.itemPorsche.casedaily.xmf.interfaceDemo.DeliverCar;
import com.haisheng.framework.testng.bigScreen.itemPorsche.casedaily.xmf.interfaceDemo.FinishReception;
import com.haisheng.framework.testng.bigScreen.itemPorsche.casedaily.xmf.interfaceDemo.OrderCar;
...
//
            ...
            array1.add(2, ll3);
            array1.add(3, ll4);
//           int code= crm.messageEvaluatecode(id,pp.abString100,array1).getInteger("code");
...
//    @Test()
    public void testdeliverstatis() {
        ...
        try {
            ...
            Preconditions.checkArgument(afternum3[1] - num[1] == 1, "交车实际交车+1");
            Preconditions.checkArgument(afternum3[0] - num[0] == 2, "交车今日交车+1");
