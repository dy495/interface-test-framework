...
import com.haisheng.framework.testng.bigScreen.jiaochenDaily.wm.sense.applet.granted.VoucherVerification;
...
public class MarketingManage extends TestCaseCommon implements TestCaseStd {
    ...
    public void initial() {
        ...
        commonConfig.referer = EnumRefer.JIAOCHEN.getRefer();
        //替换jenkins-job的相关信息
