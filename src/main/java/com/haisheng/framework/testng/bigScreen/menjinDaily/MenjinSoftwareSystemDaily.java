...
package com.haisheng.framework.testng.bigScreen.menjinDaily;
...
//--------------------------------层级管理  创建后要删掉！！！-------------------------------
    ...
    public void deletescopeWithPeople() {
        ...
        try {
            ...
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/于海生.jpg.png");
...
//--------------------------------人物管理-------------------------------
    ...
    public void useraddSameCard() {
        ...
        try {
            ...
            String face_image2 = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/于海生.jpg.png");
    ...
    public void useraddSameId() {
        ...
        try {
            ...
            String face_image2 = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/廖祥茹.jpg");
    ...
    public void useraddLowQuality() {
        ...
        try {
            ...
            String user_id = "user" + System.currentTimeMillis();
            String image_type = "BASE64";
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/分辨率较低.png");
            JSONObject single = menjin.userAddNotCheck(scope,user_id,image_type,face_image,"","");
            int code = single.getInteger("code");
            String message = single.getString("message");
            Preconditions.checkArgument(code==1001,"创建用户" + user_id + "失败，状态码" + code + " , 提示语为" + message);
    ...
    public void useraddCat() {
        ...
        try {
            ...
            String user_id = "user" + System.currentTimeMillis();
            String image_type = "BASE64";
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/猫.png");
            JSONObject single = menjin.userAddNotCheck(scope,user_id,image_type,face_image,"","");
            int code = single.getInteger("code");
            String message = single.getString("message");
            Preconditions.checkArgument(code==1001,"创建用户" + user_id + "失败，状态码" + code + " , 提示语为" + message);
    ...
    public void useraddView() {
        ...
        try {
            ...
            String user_id = "user" + System.currentTimeMillis();
            String image_type = "BASE64";
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/风景.png");
            JSONObject single = menjin.userAddNotCheck(scope,user_id,image_type,face_image,"","");
            int code = single.getInteger("code");
            String message = single.getString("message");
            Preconditions.checkArgument(code==1001,"创建用户" + user_id + "失败，状态码" + code + " , 提示语为" + message);
    ...
    public void useraddPersonWithMask() {
        ...
        try {
            ...
            String user_id = "user" + System.currentTimeMillis();
            String image_type = "BASE64";
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/单人遮挡.png");
            JSONObject single = menjin.userAddNotCheck(scope,user_id,image_type,face_image,"","");
    ...
    public void useraddPeople() {
        ...
        try {
            ...
            String user_id = "user" + System.currentTimeMillis();
            String image_type = "BASE64";
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/多人脸.png");
            JSONObject single = menjin.userAddNotCheck(scope,user_id,image_type,face_image,"","");
            int code = single.getInteger("code");
            String message = single.getString("message");
            Preconditions.checkArgument(code==1001,"创建用户" + user_id + "失败，状态码" + code + " , 提示语为" + message);
    ...
    public void userUpdateCardImage() {
        ...
        try {
            ...
            String newface = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/李婷婷.jpg");
    ...
    public void userdeleteExist() {
        ...
        try {
            ...
            String user_id = "user" + System.currentTimeMillis();
            String image_type = "BASE64";
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/李婷婷.jpg");
...
//--------------------------------边缘端-------------------------------
    ...
    public void EdgeNotExistBase64() {
        ...
        try {
            ...
            String face_image = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/廖祥茹.jpg");
...
//永久
    ...
    public void device_auth1() {
        ...
        try {
            ...
            String notexistpeople = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/ym.png");
...
//每天
    ...
    public void useradd_specialscope() {
        ...
        try {
            ...
            String faceimage = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/于海生.jpg.png");
...
//            alarmPush.setDingWebhook(DingWebhook.QA_TEST_GRP);
    ...
    private  String[] addtwoUserwithCard() throws Exception {
        ...
        String user_id2 = "user2" + System.currentTimeMillis();
        String image_type = "BASE64";
        String face_image1 = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/于海生.jpg.png");
        String face_image2 = getImgStr("src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/廖祥茹.jpg");
    ...
    public  void delPeopleScope(String scope,String user_id) throws Exception {
      ...
      // public static void main(String[] args) throws Exception {// ---不用理我！
        //String path = "src/main/java/com/haisheng/framework/testng/bigScreen/menjinDaily/MenjinImages/分辨率较低.png";
