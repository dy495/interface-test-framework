package com.haisheng.framework.testng.bigScreen.xundian.caseonline.zt;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.google.common.base.Preconditions;
import com.haisheng.framework.testng.bigScreen.xundian.casedaily.hqq.StorePcAndAppData;
import com.haisheng.framework.testng.bigScreen.xundian.casedaily.zt.DataProviderMethod;
...
//            获取今日进店新客
    ...
    public void  tradeCustomer() {
        ...
        try {
            ...
            //获取累计交易客流
            int total_enter_customer_uv = result.getInteger("total_trans_customer_uv");
            //获取累计交易客流
...
//            Integer items_value1 = items.getInteger(1);
            ...
            //获取今日交易客流的环比
            int last_week_enter_customer_qoq = today_enter_customer_flow.getInteger("yesterday_trans_customer_qoq");
            //获取详情中的环比和同比
