...
public class IntegralCenterCase extends TestCaseCommon implements TestCaseStd {
    ...
    public void integralExchange_system_9() {
        ...
        try {
            ...
            CommonUtil.checkResult("兑换品库存明细手机号", ALL_AUTHORITY_DAILY.getPhone(), exchangeStockPageList.get(0).getSalePhone());
            CommonUtil.checkResult("兑换品库存明细操作人", ALL_AUTHORITY_DAILY.getName(), exchangeStockPageList.get(0).getSaleName());
            ...
            CommonUtil.checkResult("兑换品库存明细手机号", ALL_AUTHORITY_DAILY.getPhone(), exchangeStockPageListTwo.get(0).getSalePhone());
            CommonUtil.checkResult("兑换品库存明细操作人", ALL_AUTHORITY_DAILY.getName(), exchangeStockPageListTwo.get(0).getSaleName());
