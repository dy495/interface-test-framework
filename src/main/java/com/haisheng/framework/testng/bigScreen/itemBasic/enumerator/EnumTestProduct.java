...
public enum EnumTestProduct {
    ...
    JC_DAILY_JD("汽车-轿辰 日常 ", "http://dev.jiedai.auto.winsenseos.cn", "http://dev.jiedai.auto.winsenseos.cn", "-1", "JC", "603", true),
    JC_DAILY_GK("汽车-轿辰 日常 ", "http://dev.huiting.auto.winsenseos.cn", "http://dev.huiting.auto.winsenseos.cn", "-1", "JC", "603", true),
    JC_DAILY_ZH("汽车-轿辰 日常 ", "http://dev.zhanghao.auto.winsenseos.cn", "http://dev.zhanghao.auto.winsenseos.cn", "-1", "JC", "603", true),
