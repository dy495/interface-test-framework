...
public class RiskControlCaseDataDaily extends TestCaseCommon implements TestCaseStd {
    ...
    public void authCashierPageData1() {
        ...
        try {
            //获取账号管理页面的账号数量
            int numBefore = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.staff.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
            //新建账号
            ...
            JSONObject response1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.staff.PageScene.builder().page(1).size(10).build().visitor(visitor).execute();
    ...
    public void authCashierPageData2() {
        try {
            ...
            //禁用此账号
            String message2 = cu.getStaffStatusChange(id, "DISABLE").getMessage();
            System.out.println("----message2------" + message2);
            //启用此账号
            String message3 = cu.getStaffStatusChange(id, "ENABLE").getMessage();
            System.out.println("----message3------" + message3);
            //获取账号管理页面的账号数量
            JSONObject response1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.staff.PageScene.builder().page(1).size(10).build().visitor(visitor).execute();
            int numAfter = response1.getInteger("total");
            JSONObject response2 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.staff.PageScene.builder().page(1).size(10).name(name).build().visitor(visitor).execute();
    ...
    public void authCashierPageData3() {
        try {
            //新建角色前的角色数量
            int totalBefore = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.role.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
            //新建角色
            cu.getAddRole(pp.roleName, pp.descriptionRole);
            //获取此角色的ID
            Long roleId = cu.authRoleNameTransId(pp.roleName);
            //新建角色后的角色数量
            int totalAfter = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.role.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
            //删除新建的角色
            String message = cu.getDelRole(roleId);
            //删除角色后的角色数量
            int totalDel = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.role.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
    ...
    public void authCashierPageData4() {
        try {
            ...
            JSONObject response = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.role.PageScene.builder().page(1).size(10).build().visitor(visitor).execute();
    ...
    public void authCashierPageData5() {
        try {
            ...
            for (int page = 1; page <= pages; page++) {
                JSONArray list = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.role.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getJSONArray("list");
                for (int i = 0; i < list.size(); i++) {
                    ...
                    int total = scene1.visitor(visitor).execute().getInteger("total");
    ...
    public void riskControlData6() {
        try {
            ...
            int pages = scene.visitor(visitor).execute().getInteger("pages") > 5 ? 5 : scene.visitor(visitor).execute().getInteger("pages");
            for (int page = 1; page <= pages; page++) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    //待处理
                    int pendingTotal = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(id).page(1).size(10).currentState("PENDING").build().visitor(visitor).execute().getInteger("total");
                    //已处理
                    int processedTotal = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(id).page(1).size(10).currentState("PROCESSED").build().visitor(visitor).execute().getInteger("total");
                    //已过期
                    int ExpiredTotal = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(id).page(1).size(10).currentState("EXPIRED").build().visitor(visitor).execute().getInteger("total");
        ...
        try {
            ...
            for (int page = 1; page <= pages; page++) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    //已处理
                    int processed = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(id).page(1).size(10).currentState("PROCESSED").build().visitor(visitor).execute().getInteger("total");
                    //待处理
                    int pendingTotal = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(id).page(1).size(10).currentState("PENDING").build().visitor(visitor).execute().getInteger("total");
                    //收银风控事件里面正常的事件
                    int normal = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(id).page(1).size(10).handleResult("NORMAL").build().visitor(visitor).execute().getInteger("total");
                    //收银风控事件里面异常的事件
                    int abnormal = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(id).page(1).size(10).handleResult("ABNORMAL").build().visitor(visitor).execute().getInteger("total");
        ...
        try {
            ...
            for (int page = 1; page <= pages; page++) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    JSONObject response = scene2.visitor(visitor).execute();
                    int pages1 = response.getInteger("pages") > 3 ? 3 : response.getInteger("pages");
                    for (int page1 = 1; page1 <= pages1; page1++) {
                        JSONArray list1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.TraceBackScene.builder().shopId(shopId).page(1).size(10).build().visitor(visitor).execute().getJSONArray("list");
                        for (int j = 0; j < list1.size(); j++) {
                            ...
                            //小票信息详情
                            JSONObject orderResponse = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.OrderDetailScene.builder().shopId(shopId).orderId(orderId).build().visitor(visitor).execute();
                            //小票中的订单时间
    ...
    public void riskControlData10() {
        try {
            ...
            JSONArray dataList = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getJSONArray("list");
            long shopId = dataList.getJSONObject(0).getInteger("shop_id");
            //累计风险数量
            int riskTotal = dataList.getJSONObject(0).getInteger("risk_total");
            //待处理
            int pendingTotal = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(shopId).page(1).size(10).currentState("PENDING").build().visitor(visitor).execute().getInteger("total");
            if (pendingTotal > 0) {
                //收银风控事件里面正常的事件
                int normalTotal = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(shopId).page(1).size(10).handleResult("NORMAL").build().visitor(visitor).execute().getInteger("total");

                //获取待处理风险事件ID
                JSONArray list = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(shopId).page(1).size(10).currentState("PENDING").build().visitor(visitor).execute().getJSONArray("list");
                long id = list.getJSONObject(0).getInteger("id");
                String order = list.getJSONObject(0).getString("order_id");

                //将待处理的风控事件处理成正常
                cu.getRiskEventHandle(id, 1, "订单正常", null);
                //获取处理完以后的累计正常事件和待处理事项
                JSONArray dataList1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getJSONArray("list");
                //待处理
                int pendingTotal1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(shopId).page(1).size(10).currentState("PENDING").build().visitor(visitor).execute().getInteger("total");
                //收银风控事件里面正常的事件
                int normalTotal1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(shopId).page(1).size(10).handleResult("NORMAL").build().visitor(visitor).execute().getInteger("total");
                //累计风险数量
    ...
    public void riskControlData11() {
        try {
            ...
            if (pendingTotal > 0) {
                //收银风控事件里面异常的事件
                int abnormalTotal = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(shopId).page(1).size(10).handleResult("ABNORMAL").build().visitor(visitor).execute().getInteger("total");
                ...
                //将待处理的风控事件处理成异常
                cu.getRiskEventHandle(id, 0, "订单正常", null);
                ...
                int pendingTotal1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(shopId).page(1).size(10).currentState("PENDING").build().visitor(visitor).execute().getInteger("total");
                //收银风控事件里面异常的事件
                int abnormalTotal1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(shopId).page(1).size(10).handleResult("ABNORMAL").build().visitor(visitor).execute().getInteger("total");
    ...
    public void riskControlData12() {
        ...
        try {
            ...
            JSONObject response = RiskEventPageScene.builder().shopId(shopId).page(1).size(10).currentState("PENDING").build().visitor(visitor).execute();
            if (response.getJSONArray("list").size() > 0) {
                int pages = response.getInteger("pages") > 5 ? 5 : response.getInteger("pages");
                for (int page = 1; page <= pages; page++) {
                    JSONArray list = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(shopId).page(page).size(10).currentState("PENDING").build().visitor(visitor).execute().getJSONArray("list");
                    for (int i = 0; i < list.size(); i++) {
    ...
    public void riskControlData13() {
        ...
        try {
            //新建前风控规则前列表数量
            int totalBefore = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.rule.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
            //新增一个风控规则
            Long id = cu.getRuleAdd(RuleEnum.BLACK_LIST.getType());
            //获取当前时间
            String time = DateTimeUtil.getFormat(new Date(), "yyyy-MM-dd HH:mm");
            //新建前风控规则后列表数
            JSONObject response = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.rule.PageScene.builder().page(1).size(10).build().visitor(visitor).execute();
...
//            String updateUser=response.getJSONArray("list").getJSONObject(0).getString("update_user");
            ...
            //新建前风控规则前列表数量
            int totalDel = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.rule.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
    ...
    public void riskControlData14() {
        ...
        try {
            ...
            cu.ruleSwitch(id, 0);
            //关闭风控规则后列表数量
            int totalAfter = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.rule.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
    ...
    public void riskControlData15() {
        logger.logCaseStart(caseResult.getCaseName());
        try {
            JSONObject response = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.alarm.PageScene.builder().page(1).size(10).build().visitor(visitor).execute();
            int pages = response.getInteger("pages") > 5 ? 5 : response.getInteger("pages");
            for (int page = 1; page <= pages; page++) {
    ...
    public void riskControlData16() {
        ...
        try {
            //新建风控告警规则前列表数量
            int totalBefore = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.alarmrule.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
            //新建风控告警规则
            ...
            Long id = response.getJSONArray("list").getJSONObject(0).getLong("id");
            //新建风控告警规则列后表数量
            int totalAfter = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.alarmrule.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
            ...
            //删除后的风控告警规则的总条数
            int totalDel = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.alarmrule.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
            System.out.println(totalBefore + "-------" + totalAfter + "    " + totalDel);
    ...
    public void riskControlData17() {
        ...
        try {
            ...
            Long id = scene.visitor(visitor).execute().getJSONArray("list").getJSONObject(0).getLong("id");
            ruleIdList.add(id);
            //关闭风控告警规则的第一条
            cu.getAlarmRuleSwitch(id1, 0);
            //编辑风控告警规则
            String message = cu.getAlarmRuleEdit(id1, true, 1800000L, RuleEnum.CASHIER.getType(), ruleIdList, acceptRoleIdList).visitor(visitor).getResponse().getMessage();
            //开启风控告警规则的第一条
            cu.getAlarmRuleSwitch(id1, 1);
            //查看风控告警规则的详情
            JSONObject response = DetailScene.builder().id(id1).build().visitor(visitor).execute();
    ...
    public void riskControlData18() {
        ...
        try {
            //关闭风控告警规则前列表数量
            JSONObject response = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.alarmrule.PageScene.builder().page(1).size(10).build().visitor(visitor).execute();
    ...
    public void riskControlData19() {
        ...
        try {
            //获取黑名单列表的条数
            int totalBefore = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.riskpersonnel.PageScene.builder().page(1).size(10).type("BLACK").build().visitor(visitor).execute().getInteger("total");
            //收银追溯的ID
            Long id = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getJSONArray("list").getJSONObject(0).getLong("shop_id");
            //待处理事件的ID
            JSONObject response1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(id).page(1).size(10).currentState("PENDING").build().visitor(visitor).execute();
            if (response1.getJSONArray("list").size() > 0) {
                Long pendId = response1.getJSONArray("list").getJSONObject(0).getLong("id");
                //判断此处理事件是否有人脸
                JSONObject res = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventOrderCustomerListScene.builder().id(pendId).build().visitor(visitor).execute();
                ...
                if (list.size() > 0) {
                    ...
                    //获取黑名单列表的条数
                    int totalAfter = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.riskpersonnel.PageScene.builder().page(1).size(10).type("BLACK").build().visitor(visitor).execute().getInteger("total");
                    ...
                    //删除后黑名单的条数
                    int totalDel = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.riskpersonnel.PageScene.builder().page(1).size(10).type("BLACK").build().visitor(visitor).execute().getInteger("total");
    ...
    public void riskControlData20() {
        ...
        try {
            //获取白名单列表的条数
            int totalBefore = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.riskpersonnel.PageScene.builder().page(1).size(10).type("WHITE").build().visitor(visitor).execute().getInteger("total");
            //收银追溯的ID
            Long id = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getJSONArray("list").getJSONObject(0).getLong("shop_id");
            //待处理事件的ID
            JSONObject response1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(id).page(1).size(10).currentState("PENDING").build().visitor(visitor).execute();
            if (response1.getJSONArray("list").size() > 0) {
                ...
                if (list.size() > 0) {
                    ...
                    //获取白名单列表的条数
                    int totalAfter = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.riskpersonnel.PageScene.builder().page(1).size(10).type("WHITE").build().visitor(visitor).execute().getInteger("total");
                    ...
                    //删除后白名单的条数
                    int totalDel = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.riskpersonnel.PageScene.builder().page(1).size(10).type("WHITE").build().visitor(visitor).execute().getInteger("total");
    ...
    public void riskControlData21() {
        ...
        try {
            //获取重点观察人员列表的条数
            int totalBefore = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.riskpersonnel.PageScene.builder().page(1).size(10).type("FOCUS").build().visitor(visitor).execute().getInteger("total");
            //收银追溯的ID
            Long id = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getJSONArray("list").getJSONObject(0).getLong("shop_id");
            //待处理事件的ID
            JSONObject response1 = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.cashier.RiskEventPageScene.builder().shopId(id).page(1).size(10).currentState("PENDING").build().visitor(visitor).execute();
            if (response1.getJSONArray("list").size() > 0) {
                ...
                if (list.size() > 0) {
                    ...
                    cu.getRiskEventHandle(pendId, 0, "订单异常，请关注", customerIds);
                    //获取重点观察人员列表的条数
                    int totalAfter = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.riskpersonnel.PageScene.builder().page(1).size(10).type("FOCUS").build().visitor(visitor).execute().getInteger("total");
                    ...
                    //删除后重点观察人员的条数
                    int totalDel = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.riskpersonnel.PageScene.builder().page(1).size(10).type("FOCUS").build().visitor(visitor).execute().getInteger("total");
    ...
    public void riskControlData22() {
        ...
        try {
            //获取账号管理页面的账号数量
            int num = com.haisheng.framework.testng.bigScreen.fengkongdaily.scene.auth.staff.PageScene.builder().page(1).size(10).build().visitor(visitor).execute().getInteger("total");
            //获取员工查询信息列表的条数
