...
import com.haisheng.framework.testng.bigScreen.itemPorsche.common.enumerator.other.EnumOperation;
import com.haisheng.framework.testng.bigScreen.itemPorsche.common.enumerator.sale.EnumAccount;
import com.haisheng.framework.testng.bigScreen.itemBasic.base.scene.IScene;
import com.haisheng.framework.testng.bigScreen.itemPorsche.common.scene.app.*;
import com.haisheng.framework.testng.bigScreen.itemPorsche.common.scene.pc.OrderMaintainPageScene;
import com.haisheng.framework.testng.bigScreen.itemPorsche.common.scene.pc.OrderRepairPageScene;
...
public class AfterSaleOnline extends TestCaseCommon implements TestCaseStd {
    ...
    public void afterSale_customer_data_8() {
        ...
        try {
            UserUtil.login(fw);
            JSONObject list = crm.receptionAfterCustomerTotal();
            //统计数据-今日接待售后数量
