...
public class PcDataPagePorsche extends TestCaseCommon implements TestCaseStd {
    ...
    private static final String shopId = EnumTestProduce.CRM_ONLINE_PORSCHE.getShopId();
    ...
    public void initial() {
        ...
        commonConfig.message = commonConfig.message.replace(commonConfig.TEST_PRODUCT, EnumTestProduce.CRM_ONLINE_PORSCHE.getName() + commonConfig.checklistQaOwner);
        //替换钉钉推送
