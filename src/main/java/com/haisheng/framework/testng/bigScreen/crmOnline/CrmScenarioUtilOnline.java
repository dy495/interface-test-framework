...
public class CrmScenarioUtilOnline extends TestCaseCommon {
    ...
    public static CrmScenarioUtilOnline getInstance() {
        if (null == instance) {
            synchronized (CrmScenarioUtilOnline.class) {
                if (null == instance) {
                    instance = new CrmScenarioUtilOnline();
                }
            }
        }
        return instance;
    ...
    public JSONObject receptionAfterCustomerList(Long after_record_id, String customer_name, String customer_phone_number, String customer_secondary_phone,
        ...
        if (!StringUtils.isEmpty(customer_secondary_phone)) {
...
//                + "} ";
    ...
    //*************************app relate*************************
    //app 预约试驾全部预约及今日预约人数
    public JSONObject appointmentDriverNumber() {
    ...
    //售后：客户管理->统计数据
    public JSONObject receptionAfterCustomerTotal() {
    ...
    public JSONObject customerEdit(Long customerId, String customerName, String customerPhone, int customerLevel, String belongsSaleId) {
        ...
        JSONObject object = new JSONObject();
        object.put("customer_id", customerId);
        object.put("shop_id", EnumTestProduce.CRM_ONLINE.getShopId());
        object.put("customer_name", customerName);
        object.put("customer_phone", customerPhone);
        object.put("customer_level", customerLevel);
        object.put("belongs_sale_id", belongsSaleId);
