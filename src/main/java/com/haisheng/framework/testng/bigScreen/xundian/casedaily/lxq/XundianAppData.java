package com.haisheng.framework.testng.bigScreen.xundian.casedaily.lxq;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.google.common.base.Preconditions;
import com.haisheng.framework.testng.bigScreen.xundian.util.MendianInfo;
import com.haisheng.framework.testng.bigScreen.xundian.util.XundianScenarioUtil;
...
public class XundianAppData extends TestCaseCommon implements TestCaseStd {
    ...
    public void xdOnePgae1(String type,String chinesetype) {
        ...
        try {
            ...
            JSONObject obj = xd.checkStartapp(info.shop_id_01,type,1,0);
    ...
    public void xdOnePgae2(String type, String chinesetype, String result,String mes) {
        ...
        try {
            ...
            int checkedafter = xd.checkStartapp(info.shop_id_01,type,0, 0).getJSONArray("check_lists").getJSONObject(0).getInteger("checked");
    ...
    public void xdOnePgae3(String type, String chinesetype) {
        logger.logCaseStart(caseResult.getCaseName());
        try {
            JSONArray chklist = xd.checkStartapp(info.shop_id_01,type,1,0).getJSONArray("check_lists");
    ...
    public void xdOnePgae4(String type,String chinesetype) {
        ...
        try {
            ...
            JSONArray chklist = xd.checkStartapp(info.shop_id_01,type,0,0).getJSONArray("check_lists");
            for (int i=0; i < chklist.size(); i++){
                int itemsum = 0;
                JSONObject eachlist = chklist.getJSONObject(i);
    ...
    public void xdSevlPgae1(String type, String chinesetype, String result,String mes) {
        ...
        try {
            ...
            //巡店
            info.xdOperate(info.shop_id_01,type,1,Integer.parseInt(result),0);
    ...
    public void xdSevlPgae3(String type,String chinesetype) {
        ...
        try {
            ...
            //巡店
            info.xdOperate(info.shop_id_01,type,1,2,0);
    ...
    public void xdSevlPgae4(String type,String chinesetype) {
        ...
        try {
            ...
            double bef1 =xd.xd_analysis_data().getDouble("today_patrol_pass_rate");
            //巡店
            info.xdOperate(info.shop_id_01,type,1,1,0);
            double after1 =xd.xd_analysis_data().getDouble("today_patrol_pass_rate");
            double add1 = after1 - bef1;
