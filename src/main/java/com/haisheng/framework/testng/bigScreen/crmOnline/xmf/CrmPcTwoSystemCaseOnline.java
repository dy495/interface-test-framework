...
//     @Test
     ...
     **/
    @Test(dataProvider = "POSITIONS",dataProviderClass = CrmScenarioUtilOnlineX.class)
...
//            String activity_id=dataM.getString("activity_id");
     ...
     **/
//     @Test(dataProvider = "APOSITIONS",dataProviderClass = CrmScenarioUtilOnlineX.class)
