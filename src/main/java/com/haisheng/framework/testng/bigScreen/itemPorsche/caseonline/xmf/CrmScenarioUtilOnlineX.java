...
public class CrmScenarioUtilOnlineX extends TestCaseCommon {

    /**
     * 单例，确保多个类共用一份类
     * 此部分不变，后面的方法自行更改
     */
    private static volatile CrmScenarioUtilOnlineX instance = null;
    CustomerInfoOnline cstm = new CustomerInfoOnline();

    private CrmScenarioUtilOnlineX() {
    }

    public static CrmScenarioUtilOnlineX getInstance() {
        if (null == instance) {
            synchronized (CrmScenarioUtilOnlineX.class) {
                if (null == instance) {
                    instance = new CrmScenarioUtilOnlineX();
                }
            }
        }
        return instance;
    ...
    public String getPorscheShop() {
        return EnumTestProduce.PORSCHE_ONLINE.getShopId();
    }
...
//        json1.put("source_channel",source_channel);
    ...
    public JSONObject finishReception2(String belongs_sale_id, Long reception_id, Long customer_id, String name, JSONArray phone_list, String reception_type) throws Exception {
        ...
        json1.put("expected_buy_day", dt.getHistoryDate(1));
        json1.put("intention_car_model", "82");
        json1.put("address", "东城");
        json1.put("is_assessed", "1");
        json1.put("is_offer", "1");
        json1.put("name", name);
        ...
        json1.put("test_drive_car_model", "82");
...
//        json1.put("test_drive_car",test_drive_car);
    ...
    //预约保养
    public JSONObject appointmentMaintainCode(Long my_car_id, String customer_name, String customer_phone_number,  Long time_range_id) throws Exception {
        String url = "/WeChat-applet/porsche/a/appointment/maintain";
        JSONObject json1 = new JSONObject();
        json1.put("my_car_id", my_car_id);
        json1.put("customer_name", customer_name);
    ...
    public JSONObject createLine(String customer_name, int like_car, String customer_phone, Integer customer_level, String remark) throws Exception {
        ...
        if (!(like_car <= 0)) {
            json.put("intention_car_model", 81);
        }
