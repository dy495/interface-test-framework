...
/**
 * 13.5. 在线专家咨询列表导出 （池）(2021-03-08)
 *
 * @author wangmin
 * @date 2021-07-27 18:26:28
 */
@Builder
public class ConsultManagementOnlineExpertsPageListExportScene extends BaseScene {
    /**
     * 描述 页码 大于0
     * 是否必填 true
     * 版本 v1.0
    ...
    public String getPath() {
        return "/car-platform/pc/consult-management/online-experts-page-list-export";
    }
}