...
import com.haisheng.framework.testng.bigScreen.crmDaily.wm.enumerator.config.EnumStatus;
...
import com.haisheng.framework.testng.bigScreen.jiaochenDaily.wm.enumerator.EnumAccount;
import com.haisheng.framework.testng.bigScreen.jiaochenDaily.wm.enumerator.EnumContent;
import com.haisheng.framework.testng.bigScreen.jiaochenDaily.wm.enumerator.EnumPushTarget;
...
import com.haisheng.framework.testng.bigScreen.jiaochenDaily.wm.sense.pc.packagemanager.BuyPackageRecord;
import com.haisheng.framework.testng.bigScreen.jiaochenDaily.wm.sense.pc.packagemanager.CreatePackage;
import com.haisheng.framework.testng.bigScreen.jiaochenDaily.wm.sense.pc.packagemanager.PackageFormPage;
...
import com.haisheng.framework.testng.bigScreen.jiaochenDaily.wm.util.BusinessUtil;
...
public class BusinessUtilOnline {
     ...
     * @return 核销码
     */
    public Long getVerificationCode(String verificationIdentity) {
        ...
        for (int i = 1; i < s; i++) {
            ...
            for (int j = 0; j < list.size(); j++) {
                if (list.getJSONObject(j).getBoolean("verification_status")
                    ...
                    return list.getJSONObject(j).getLong("verification_code");
                }
            }
        }
        return null;
