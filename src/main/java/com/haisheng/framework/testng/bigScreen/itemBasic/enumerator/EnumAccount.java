...
public enum EnumAccount {
    ...
    JC_ALL_AUTHORITY_ONLINE("15037286012", "000000", "所有权限", false, "石矶娘娘", "2227", "-1", "20032"),

    JC_ALL_ONLINE_LXQ("15037286012", "000000", "所有权限", false, "石矶娘娘", "2227", "-1", "20032"),

    JC_ALL_ONLINE("15711200001", "000000", "所有权限", false, "轿辰线上", "395", "-1", "-1"),

    JC_ALL_ONLINE_MC("13412090005", "000000", "所有权限", false, "接待", "7138", "-1", "36319"),
