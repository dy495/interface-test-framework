...
public enum EnumAccount {
    ...
    JC_DAILY_LXQ("13402050025", "000000", "全部角色", true, "预约应答13402050025", "uid_df9293ba", "2942", "-1", "46522", ""),
    ...
    EnumAccount(String phone, String password, String role, boolean isDaily, String name, String uid, String roleId, String shopId, String receptionShopId, String receptionShopName) {
        this.role = role;
        this.phone = phone;
