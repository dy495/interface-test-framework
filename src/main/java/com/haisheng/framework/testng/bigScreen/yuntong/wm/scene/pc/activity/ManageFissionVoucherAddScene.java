...
/**
 * 29.4. 创建裂变优惠券活动 （谢）（2021-01-13）
 *
 * @author wangmin
 * @date 2021-05-18 17:04:36
 */
@Builder
public class ManageFissionVoucherAddScene extends BaseScene {
    /**
     * 描述 活动类型 见字典表《活动类型》
     * 是否必填 true
     * 版本 v2.0
    ...
    public String getPath() {
        return "/account-platform/auth/activity/manage/fission-voucher/add";
    }
}