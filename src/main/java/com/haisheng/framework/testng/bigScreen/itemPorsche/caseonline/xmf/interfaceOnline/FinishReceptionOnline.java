package com.haisheng.framework.testng.bigScreen.itemPorsche.caseonline.xmf.interfaceOnline;
...
public class FinishReceptionOnline {
    ...
    public String intention_car_model="81";
    public String expected_buy_day = dt.getHistoryDate(1);
    public String test_drive_car_model = "81";
    public String pay_type = "1";
    public String assess_car_model = "81";
