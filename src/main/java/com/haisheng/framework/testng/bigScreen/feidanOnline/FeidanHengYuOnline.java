...
public class FeidanHengYuOnline {
...
//-----------------人脸搜索-----------
    ...
    public static Object[] pic() {
        return new String[]{
                "src/main/java/com/haisheng/framework/testng/bigScreen/feidanImages/hengyu1.png",
                "src/main/java/com/haisheng/framework/testng/bigScreen/feidanImages/hengyu2.png"
        };
