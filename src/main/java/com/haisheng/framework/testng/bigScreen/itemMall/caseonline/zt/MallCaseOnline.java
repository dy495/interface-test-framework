...
//        mall.login("yuexiu@test.com", "f5b3e737510f31b88eb2d4b5d0cd2fb4");
    ...
    public void mallShopDataCase1() {
        try {
            JSONArray shoplist0 = ShopPageScene.builder().size(size).page(page).startTime(starting).endTime(ending).build().visitor(visitor).execute().getJSONArray("list");
...
//            String startMess = StatusChangeScene.builder().id(Integer.parseInt(id)).status("ENABLE").build().execute(visitor,false).getMessage();
