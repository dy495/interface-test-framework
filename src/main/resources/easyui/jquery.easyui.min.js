...
return $("body>div.messager-window").find("div.messager-util-bar");
},close:function(){
...
var _283="<div class=\"messager-progress\"><div class=\"messager-util-msg\"></div><div class=\"messager-util-bar\"></div></div>";
var win=_271(opts.title,_283,null);
win.find("div.messager-util-msg").html(opts.msg);
var bar=win.find("div.messager-util-bar");
...
tab.find("span.tabs-util-tool").remove();
if(opts.tools){
var _311=$("<span class=\"tabs-util-tool\"></span>").insertAfter(tab.find("a.tabs-inner"));
if($.isArray(opts.tools)){
for(var i=0;i<opts.tools.length;i++){
...
_7fc.panel({doSize:false,closed:true,cls:"combo-util",style:{position:"absolute",zIndex:10},onOpen:function(){
$(this).panel("resize");
},onClose:function(){
...
var p=$(e.target).closest("span.combo,div.combo-util");
if(p.length){
_808(p);
return;
}
$("body>div.combo-util>div.combo-panel:visible").panel("close");
});
_80f.unbind(".combo");
_810.unbind(".combo");
